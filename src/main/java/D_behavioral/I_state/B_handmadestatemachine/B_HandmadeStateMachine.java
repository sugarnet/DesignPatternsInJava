package D_behavioral.I_state.B_handmadestatemachine;
...
public class B_HandmadeStateMachine {
...
enum Trigger {
    CALL_DIALED, HUNG_UP, CALL_CONNECTED, PLACED_ON_HOLD, TAKEN_OFF_HOLD, LEFT_MESSAGE,
    STOP_USING_PHONE
}