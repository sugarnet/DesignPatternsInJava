...
public class A_VectorRasterDemo {
    ...
    public static void draw() {
        for (VectorObject vo : VECTOR_OBJECTS) {
            for (Line line : vo) {
                ...
                adapter.forEach(A_VectorRasterDemo::drawPoint);
            }
        }
    }*/
}
...
/**
 * uncomment the following lines if you want test. These classes are in the other class
 *
class Point {
    public int x, y;
